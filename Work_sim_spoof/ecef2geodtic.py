...
from math import *
#import ecef2geodtic_def


#------From the paper(https://hal.archives-ouvertes.fr/hal-01704943v2/document) 
#  under: wgs84data.h
####################################################
invaa = 2.45817225764733181057e-0014# 1/ (a²)
aadc = 7.79540464078689228919e+0007 # a²/c
bbdcc = 1.48379031586596594555e+0002 # (b²)/(c²)
l = 3.34718999507065852867e-0003 # (e²)/2
p1mee = 9.93305620009858682943e-0001 # 1-(e²)
p1meedaa = 2.44171631847341700642e-0014 # (1-(e²))/(a²)
Hmin = 2.25010182030430273673e-0014 # (e¹²)/4
ll4 = 4.48147234524044602618e-0005 # 4*(l²) = e⁴
ll = 1.12036808631011150655e-0005 # l² = (e⁴)/4
